      ...
      child: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                const Expanded(
                  child: Text(
                    'You are not alone. Connect, share and learn with moms on the same beautiful journey.',
                    style: TextStyle(
                      fontSize: 13,
          ...
          const _DiscussionTile(
            title: 'How to deal with back pain in pregnancy?',
            meta: '42 replies · 1h ago',
            tag: 'Wellness',
            tagColor: Color(0xFF4CAF7A),
          ),
          const _DiscussionTile(
            title: 'Best foods for second trimester?',
            meta: '28 replies · 3h ago',
            tag: 'Nutrition',
            tagColor: Color(0xFFE07A4A),
          ),
          const _DiscussionTile(
            title: 'When did you first feel baby kick?',
            meta: '67 replies · 5h ago',
            tag: 'Pregnancy',
            tagColor: AppColors.magenta,
          ),
          const _DiscussionTile(
            title: 'Hospital bag checklist for delivery',
            meta: '19 replies · 1d ago',
            tag: 'Delivery',
