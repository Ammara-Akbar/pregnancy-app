...
class MiscarriagePlanOverviewScreen extends StatelessWidget {
  const MiscarriagePlanOverviewScreen({super.key});

  static const _features = [
    (
      Icons.favorite_rounded,
      'Physical Recovery Guide',
      'Gentle tips for healing your body after loss',
    ),
    (
      Icons.psychology_alt_outlined,
      'Grief & Emotional Support',
      'Daily check-ins and compassionate guidance',
    ),
    (
      Icons.spa_outlined,
      'Self-Care Resources',
      'Rest, mindfulness, and healing rituals',
    ),
    (
      Icons.calendar_month_rounded,
      'Follow-up Care & Appointments',
      'Reminders for checkups and recovery care',
    ),
    (
      Icons.restaurant_rounded,
      'Healing Nutrition Plan',
      'Iron-rich foods, hydration & recovery meals',
    ),
    (
      Icons.sentiment_satisfied_alt_rounded,
      'Mood & Mental Health Support',
      'Track how you feel and get gentle support',
    ),
    (
    ...
    (
      ...
      'Trusted advice for physical and emotional healing',
    ),
  ];
                        ...
                        Positioned(
                          ...
                          child: const Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 10),
                              Text(
                                'Compassionate guidance and resources to help you through your recovery and healing journey.',
                                style: TextStyle(
                                  fontSize: 13,
              ...
              children: [
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: const Text('Continue with Miscarriage Support Plan'),
                  ),
                ),
