...
class NewMotherPlanPersonalizeScreen extends StatefulWidget {
  ...
  State<NewMotherPlanPersonalizeScreen> createState() =>
      _NewMotherPlanPersonalizeScreenState();
}

class _NewMotherPlanPersonalizeScreenState
    extends State<NewMotherPlanPersonalizeScreen> {
  final _nameController = TextEditingController(text: 'Ayesha Khan');
  DateTime? _deliveryDate = DateTime(2024, 5, 10);
  String _deliveryType = 'Normal Delivery';
  String _breastfeeding = 'Yes';
  ...
  static const _breastfeedingOptions = ['Yes', 'No', 'Mixed Feeding'];
                ...
                child: Column(
                  children: [
                    ...
                    _LabeledField(
                      ...
                      child: Text(_deliveryType, style: _valueStyle),
                    ),
                    const SizedBox(height: 14),
                    _LabeledField(
                      ...
                      onTap: () => _pickOption(
                        title: 'Breastfeeding',
                        options: _breastfeedingOptions,
                        current: _breastfeeding,
                        onSelected: (v) => setState(() => _breastfeeding = v),
                      ),
                      trailing: const Icon(
                        Icons.keyboard_arrow_down_rounded,
                        color: AppColors.skipGrey,
                      ),
                      child: Text(_breastfeeding, style: _valueStyle),
                    ),
                    const SizedBox(height: 14),
                    _LabeledField(
                          ...
                          const Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 4),
                                Text(
                                  'This helps us create a plan tailored to your recovery and your baby\'s needs.',
                                  style: TextStyle(
                                    fontSize: 12.5,
                                    color: AppColors.textMuted,
                                    height: 1.4,
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 14),
                  const _StepDots(activeIndex: 4, count: 5),
                ],
              ),
            ),
          ],
